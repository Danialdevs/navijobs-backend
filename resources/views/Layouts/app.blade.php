...
<body class="bg-gray-100 font-sans">
    <div class="container mx-auto px-4 ">
        <header class="header bg-white rounded-b-xl shadow-md flex justify-between items-center px-4 md:px-8 py-2">
            <div class="logo">
                <img src="{{asset("images/logo 75.svg")}}" alt="" class="h-12">
            </div>
            <nav class="top-nav">
                <ul class="flex gap-4">
                    <li><a href="#" class="circle p-2 flex items-center justify-center"><img src="/img/message-question.svg" alt=""></a></li>
                    <li><a href="#" class="circle p-2 flex items-center justify-center"><img src="/img/notification.svg" alt=""></a></li>
                ...
                <nav class="flex flex-col items-center gap-4 flex-1">
                    ...
                    <div class="login-button mt-auto">
                        <button onclick="window.location.href='login.html'" class="btn-sidebar flex items-center">
                            <img src="/img/exit.svg" class="h-6 w-6" alt="">
